...
export default function TestimonialSection() {
  ...
  return (
    <section className="w-full bg-[#EBE8E1] py-24 px-6 flex flex-col items-center">
      <div className="text-center mb-16">
        <h3 className="text-[#5b5b72] text-[14px] md:text-[15px] font-semibold tracking-wider uppercase mb-5">
          What Our Clients Say
        </h3>
        <h2 className="text-3xl md:text-[40px] text-[#1A3FA8] font-medium max-w-2xl mx-auto leading-snug">
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
        {testimonials.map((t, idx) => (
          <div key={idx} className="bg-white p-8 lg:p-10 flex flex-col items-start text-left shadow-sm">
            {/* Stars */}
