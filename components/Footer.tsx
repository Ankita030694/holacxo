      ...
      <div className="relative z-10 w-full max-w-7xl flex flex-col">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end w-full mt-8 md:mt-12">
          ...
          <div className="flex gap-4">
            {/* Twitter/X icon */}
            <Link href="#" className="w-[50px] h-[50px] bg-[#F2F0EB] flex items-center justify-center hover:bg-white transition-colors">
            ...
            {/* Instagram icon */}
            <Link href="#" className="w-[50px] h-[50px] bg-[#F2F0EB] flex items-center justify-center hover:bg-white transition-colors">
              <svg className="w-7 h-7 text-[#111155]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
